...
public class DBHelper extends SQLiteOpenHelper
{
    ...
    private static String CREATE_TABLE_MATERIAS = "CREATE TABLE " + TABLE_MATERIAS + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_ID_CURSO + " TEXT, " +KEY_MATERIA + " TEXT," +  KEY_CANT_GRUPOS + " INTEGER " +")";
  ...
  /*  public List<Grupo> findGruposByIdMateria(int id_mmateria)
    ...
    public List<Materia>findMateriasByIdCurso(int id_curso){
        ...
        Cursor cursor = db.query(TABLE_MATERIAS, new String[] { KEY_ID, KEY_ID_CURSO, KEY_MATERIA,KEY_CANT_GRUPOS}, KEY_ID_CURSO + "=?", new String[] { String.valueOf(id_curso) }, null, null, null, null);
    ...
    public Materia findMateriaByIdCursoNombre(int id_curso, String nombre){
    	...
    	SQLiteDatabase db = this.getReadableDatabase();
        Materia materia = null;
        String[] select = new String[] { KEY_ID, KEY_ID_CURSO, KEY_MATERIA,KEY_CANT_GRUPOS };
